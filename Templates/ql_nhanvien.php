...
<body>
    <div class="main">
        <div class="header">
            ...
            <form action="admin.php?task=pageNhanVien" method="post" class="form-box">
                <div class="btn-box">
                    <button name="snv" class="search-btn"><i class="ti-search"></i></button>
                </div>

                <div class="input-box">
                    <input name="search" type="search" class="input-search-box" placeholder="Tìm kiếm">
                </div>
            </form>
                ...
                <div class="content-right">
                    <table class="content-table">
                        ...
                        <tbody>
                            ...
                            isset($_POST['snv'])?$result = $control->searchnv():$result = $control->getNV();
                            $id = 1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="td-setting js-delete"
                                            href="admin.php?task=pageNhanVien&manv=<?php echo $row['manv'] ?>">Xoá</a>
                                    </td>
                                </tr>
                            <?php } ?>
        ...
        <div class="modal-container js-modal-container">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <input name="manv" type="text" class="modal-input" placeholder="Điền Mã Nhân Viên">

                    <label for="" class="modal-label">
                        Tên Nhân Viên
                    </label>
                    <input name="tennv" type="text" class="modal-input" placeholder="Điền Tên Nhân Viên">
            ...
            <div class="modal-body">
                <div class="box-fix">
                    <form action="" method="post">
                        ...
                        <input name="manv" type="text" class="modal-input" placeholder="Sửa Mã Nhân Viên">

                        <label for="" class="modal-label">
                            Tên Nhân Viên
                        </label>
                        <input type="text" name="tennv" class="modal-input" placeholder="Sửa Tên Nhân Viên">

                        <label for="" class="modal-label">
                            Gmail
                        </label>
                        <input type="email" name="email" class="modal-input" placeholder="Sửa Gmail">

                        <label for="" class="modal-label">
                            Số Điện Thoại
                        </label>
                        <input type="text" name="sdt" class="modal-input" placeholder="Sửa Số Điện Thoại">

                        <label for="" class="modal-label">
                            Quê Quán
                        </label>
                        <input type="text" name="quequan" class="modal-input" placeholder="Sửa Quê Quán">
